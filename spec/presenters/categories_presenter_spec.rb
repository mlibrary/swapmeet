  ...
  describe 'presenters' do
    ...
    it do
      ...
      subject.each.with_index do |model_presenter, index|
        ...
        expect(model_presenter.policy.object).to be_a(CategoryPolicyAgent)
        expect(model_presenter.policy.object.client_type).to eq :Category.to_s
        expect(model_presenter.policy.object.client).to be categories[index]
